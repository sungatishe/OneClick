...
def index(request):
    ...
    adress.setChatId(get_value_from_model_using_sql("chatId", name))
    return render(request, 'main.html')


staticmethod
def get_value_from_model_using_sql(find, name):
    sql_query = f"SELECT {find} FROM main_ChatIds WHERE caffeName = '{name}'"
